...
public class GoalSeeker : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        mActions[0] = new Action("drink some coffee");
        ...
        mActions[3] = new Action("sleep in the batcave");
        ...
        mActions[4] = new Action("drink some water");
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.E))
        {
            ...
            output.text = "I think I will " + bestThingToDo.name;
